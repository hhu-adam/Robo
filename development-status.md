...
| FunctionBij                   | Iso      | +              | TODO   |              | TODO   |         | TODO    |                                                                                                  |
| FunctionImage                 | Ikono    | +              |        |              |        |         | TODO    |                                                                                                  |
| Cantor                        | ==       | ++             | +      | +            | +      |         | +++     |                                                                                                  |
| Robotswana                    | ==       | ++             | +      | update (L05) | update |         | +++     |                                                                                                  |
| Prime                         | Atomo    | +              | TODO   | TODO         | TODO   |         | TODO    | (introduce ∃!) TODO: Boss: only even prime is 2                                                  |
| SetTheory                     | Synolo   | TODO           |        |              |        |         |         | TODO: use set of primes in examples; introduce Finite; new Boss: set of primes is infinite       |
